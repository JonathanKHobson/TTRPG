export const eventContent = {
  ...
  intro:
    "Your intel hub: travel details, grocery claims, side quests, and party chaos — all here.",
  sceneKicker: "RuneSpark Celebration Logistics",
  sceneHeadline: "Your scroll is standing by.",
  sceneCopy:
    "Pick your adventurer. We'll pull the right scroll — no paperwork sabotage, probably.",
  sceneSecondary:
    "March 21. Mesa. Daggerheart at 4 PM. Food, side quests, and procurement drama follow.",
  primaryCTA: "Issue Scroll",
  namePrompt: "Choose your adventurer record",
  inviteSelectHint:
    "Pick your name. Your scroll arrives pre-loaded with obligations.",
  scrollHeadline: "March 21 field notice",
  satireTagline:
    "Issued by RuneSpark Celebration Logistics. Applause doubles as legal consent.",
  personalizedLead:
    "Looks good? Dive in for travel info, grocery duty, side quests, and mandatory chaos.",
  ...
  accommodation:
    "Out-of-town guests are welcome to stay at Kyle's house between March 15 and March 24.",
  safetyNote:
